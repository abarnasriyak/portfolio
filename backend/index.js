...
// Verify connection and create messages table if not exists
async function initDB() {
  try {
    ...
    `);
    console.log('Database table "messages" verified/created successfully.');
    connection.release();
  } catch (error) {
...
// Route: Save contact form message and optionally email it
app.post('/api/send-email', async (req, res) => {
  ...
  try {
    ...
    console.log(`Saved message to database (ID: ${result.insertId})`);
...
// Route: Get all contact submissions (Admin only)
...
// Route: Delete a message (Admin only)
...
// Route: Verify admin passcode (Login)
